...
# Substitute: snake-royale, coworld-snake-royale, 4.
#
...
#
# env:
#   SMOKE_IMAGE                image, if not given as $1        (coworld-snake-royale:ci)
#   SMOKE_SLUG                 game slug                        (snake-royale)
#   SMOKE_GAME_BIN             game entrypoint                  (/bin/snake-royale)
#   SMOKE_PLAYER_BIN           player entrypoint                (/bin/snake-royale-player)
...
image="${1:-${SMOKE_IMAGE:-coworld-snake-royale:ci}}"
slug="${SMOKE_SLUG:-snake-royale}"

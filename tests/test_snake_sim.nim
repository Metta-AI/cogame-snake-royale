...
## stream, the bounded flood fill, the alliance audit, the end conditions and
## the determinism greps (design note §Tests 1-18). Numbered test 15, the
## scoring, lives in `tests/test_snake_scoring.nim` -- the file design
## §Scoring names for it.
...
# 15. scoring -- tests/test_snake_scoring.nim, the file design §Scoring names.
